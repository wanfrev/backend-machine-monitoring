...
export async function up(pgm: MigrationBuilder): Promise<void> {
  pgm.createTable("employee_daily_reports", {
    id: "id",
    employee_id: {
      type: "integer",
      notNull: true,
  ...
  pgm.addConstraint(
    ...
    "employee_daily_reports_nonnegative",
    "CHECK (\
  ...
  pgm.createIndex("employee_daily_reports", "employee_id");
  pgm.createIndex("employee_daily_reports", "report_date");
  pgm.createIndex("employee_daily_reports", "created_at");
}

export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.dropTable("employee_daily_reports");
}
